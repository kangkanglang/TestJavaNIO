 ...
 *
 * 六、字符集：Charset
 * 编码：字符串-》字节数组 （CharBuffer -->> ByteBuffer）
 * 解码：字节数组-》字符串 （ByteBuffer -->> CharBuffer）
 */
public class TestChannel {
    ...
    public void test1(){
        ...
        try{
            fis=new FileInputStream("d:/test.pdf");
            fos=new FileOutputStream("d:/test2.pdf");
    ...
    public void test2() {
        ...
        FileChannel outChannel=null;
        try {
            inChannel = FileChannel.open(Paths.get("d:/test.pdf"), StandardOpenOption.READ);
            outChannel=FileChannel.open(Paths.get("d:/test2.pdf"), StandardOpenOption.WRITE,StandardOpenOption.READ,StandardOpenOption.CREATE);
